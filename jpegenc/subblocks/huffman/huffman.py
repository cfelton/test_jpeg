...
def huffman(clock, reset, huffmancntrl, bufferdatabus,
    ...
    inst_dc_rom = dc_rom(clock, reset, huffmandatastream.vli_size,
                         vlc_dc_size, vlc_dc)

    inst_ac_rom = ac_rom(clock, reset, huffmandatastream.runlength,
                         huffmandatastream.vli_size, vlc_ac_size, vlc_ac)

    inst_cr_dc_rom = dc_cr_rom(clock, reset, huffmandatastream.vli_size,
                               vlc_cr_dc_size, vlc_cr_dc)

    inst_cr_ac_rom = ac_cr_rom(clock, reset, huffmandatastream.runlength,
